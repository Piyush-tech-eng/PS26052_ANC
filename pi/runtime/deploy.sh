...
echo ""
echo "--- Pi 5 File-Based Inference Server (Optional) ---"
echo "To launch the HTTP inference server for batch file processing:"
echo "  source ~/anc_env/bin/activate"
echo "  python inference_server.py --port 8090"
echo ""
echo "The inference server accepts WAV files over HTTP and returns"
echo "enhanced audio with processing telemetry. See inference_server.py --help."
echo "=============================================================================="
